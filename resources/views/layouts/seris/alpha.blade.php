...
<div class="container">
    <div class="col-md-offset-5" style="direction: rtl;">
        <div class="row">        
            <h2>سریال ها براساس حروف الفبا</h2>
            <br>
        </div>
    </div>
                    ...
                    <?php $counter=1; ?>
                        @foreach($seris as $seris)
                                <tr>
                                        ...
                                        <th id="centerer">{{$seris->avg}}</th>
                                        <th id="centerer">{{$seris->count}}</th>
                                        <th id="centerer"> 
                            <?php //فرم ارسال اطلاعات برای ثبت رای ?>
                                            <form method="GET" class="content" action="<?= Url('Seris/alpha') ?>">
                                            @if (Auth::guest())
